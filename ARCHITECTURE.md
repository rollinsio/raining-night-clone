...
src/combat/Weapons.js      weapon table (type, dmg, scaling, moveset id, rarity, skill id), movesets (timings, hitbox frames, motion values), WEAPON_SKILLS (one art per weapon type)
