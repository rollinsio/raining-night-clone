...
export const NIGHTFARERS = [
  ...
  { id: 'Ironeye', name: 'Ironeye', hp: 360, fp: 90, stamina: 125, weapon: 'bow', desc: 'A keen-eyed scout who marks weak points. Recurve bow; a held shot pierces harder.' },
  { id: 'Raider', name: 'Raider', hp: 500, fp: 50, stamina: 120, weapon: 'axe', desc: 'A brawler who trades blows with giants. Great axe.' },
  { id: 'Recluse', name: 'Recluse', hp: 300, fp: 160, stamina: 90, weapon: 'staff', desc: 'A sorceress who harvests affinities. Glintstone staff; a held cast hurls a comet.' },
